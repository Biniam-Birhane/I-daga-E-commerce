        ...
        <div id="carousel-example" class="relative">
            ...
            <div class="relative h-56 overflow-hidden rounded-lg sm:h-64 xl:h-80 2xl:h-96">
                ...
                <div id="carousel-item-1" class="hidden duration-700 ease-in-out">
                    ...
                    <img src="../../assets/img/image4.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <!-- Item 2 -->
                <div id="carousel-item-2" class="hidden duration-700 ease-in-out ">
                    <img src="../../assets/img/image5.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <!-- Item 3 -->
                <div id="carousel-item-3" class="hidden duration-700 ease-in-out">
                    <img src="../../assets/img/image6.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <!-- Item 4 -->
